...
pub const DEFAULT_WIDTH: f32 = 420.;
...
pub const DEFAULT_BORDER_RADIUS: f32 = 7.5;
pub const DEFAULT_BORDER_WIDTH: f32 = 2.;

pub const DEFAULT_PRIMARY_BACKGROUND_COLOR: Color = Color::srgb(25. / 255., 25. / 255., 25. / 255.);
pub const DEFAULT_SECONDARY_BACKGROUND_COLOR: Color = Color::srgb(35. / 255., 35. / 255., 35. / 255.);
pub const DEFAULT_TERTIARY_BACKGROUND_COLOR: Color = Color::srgb(80. / 255., 80. / 255., 80. / 255.);
