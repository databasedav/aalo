...
pub const DEFAULT_SECONDARY_BACKGROUND_COLOR: Color =
    Color::srgb(35. / 255., 35. / 255., 35. / 255.);
pub const DEFAULT_TERTIARY_BACKGROUND_COLOR: Color =
    Color::srgb(80. / 255., 80. / 255., 80. / 255.);
